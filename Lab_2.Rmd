...
```{r}
ggplot(precip_delay, aes(x=precip, y=delay, color=-precip))+
  geom_point()+
  ggtitle("Precip vs Delay")+
...
ggplot(flights_airports, aes(x= lon, y= lat, color=delay, size=delay))+
  geom_point()+
  ggtitle("Delay in funtion of lon and lat")+
  labs(x="lon", y= "lat")
```
